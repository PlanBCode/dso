        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content bg-gray-200">
                ...
                <div class="modal-body bg-white">
                    <p>Je onderwerp is verstuurd! Dankjewel voor het insturen.</p>
                    ...
                    <p>Vanaf 1 mei kunnen mensen stemmen op de verschillende ingestuurde ideeën, dus ook op jouw onderwerp. Op 15 mei sluiten de stembussen en weten we welk onderwerp de Stadsbron gaat onderzoeken!</p>
